...
export const fr = {
  ...
  debt: {
    add: {
      ...
      steps: {
        who: "Qui ?",
        whoSub: "Contact et type de dette",
        amount: "Combien ?",
        amountSub: "Montant et devise",
        when: "Quand ?",
        whenSub: "Dates et notes"
      },
      savedContacts: {
      ...
      phoneBook: {
        ...
        permissionDenied: "L'accès aux contacts a été refusé.",
        permissionDeniedTitle: "Accès aux contacts",
  ...
  settings: {
    ...
    autoLockUpdated: "Minuterie de verrouillage mise à jour",
    shufflePinEnabled: "Mélange du clavier PIN activé",
    shufflePinDisabled: "Mélange du clavier PIN désactivé",
