    ...
    <ScrollView className="flex-1 bg-gray-50" contentContainerStyle={{ paddingBottom: 40 }}>
      <View className="p-6">
            ...
            <View className="flex-row flex-wrap gap-2">
              {["USD", "EUR", "XAF", "GBP"].map((curr) => (
                <Pressable
                  ...
                  className={`px-4 py-2 rounded-full ${currency === curr ? "bg-primary" : "bg-gray-100"}`}
                >
        ...
        <View className="bg-white p-6 rounded-xl shadow-sm border border-red-100">
          ...
          <Pressable 
            onPress={() => {}}
            className="flex-row items-center justify-between py-3 border-t border-red-100"
          >
          ...
          <Pressable 
            ...
            className="flex-row items-center justify-center py-3 border-t border-red-100 mt-4"
          >
